...
// SKETCH: the "router" version of the root page. Instead of pitching one track,
// it says who Ben is in neutral terms and lets the visitor pick their door.
// If adopted, this becomes `/` and the current homepage moves to `/commercial`.
    ...
    <main className="min-h-screen">
      <header className="border-b border-rule">
        <div className="mx-auto flex max-w-content items-center justify-between px-6 py-4">
          <Link href="/start" className="font-serif text-lg font-semibold tracking-tight">
            Ben Morrell
          </Link>
